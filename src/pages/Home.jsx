      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="lg:hidden min-h-screen flex flex-col justify-center relative z-10">
          <div className="flex-1 flex flex-col justify-center px-4 py-8 max-h-screen overflow-y-auto">
            <div className="max-w-md mx-auto w-full bg-white/20 backdrop-blur-lg rounded-3xl shadow-2xl border border-white/30 p-6">
                  ...
                  return (
                    <button
                      ...
                      className={`relative w-full min-h-[70px] p-4 rounded-2xl border-2 transition-all duration-300 text-left ${
                       isSelected
                         ? 'border-rose-300/70 bg-gradient-to-r from-rose-100/50 via-pink-100/40 to-purple-100/50 shadow-xl shadow-rose-200/40 scale-[1.02]'
                         : 'border-slate-200/30 bg-white/30 backdrop-blur-md active:border-rose-200 hover:scale-[1.01] hover:shadow-lg'
                      }`}
                    >
                      {isLastUsed && (
                        <motion.div 
          ...
          <div className="w-[60%] flex items-center justify-center p-8 xl:p-10">
            <div className="w-full max-w-lg">
              <motion.div 
                ...
                className="bg-white/30 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-white/30 p-7 xl:p-8 space-y-5"
                    ...
                    return (
                      <button
                        ...
                        className={`relative w-full p-4 rounded-2xl border-2 transition-all duration-300 text-left flex items-center gap-3 ${
                          isSelected
                            ? 'border-rose-300/70 bg-gradient-to-r from-rose-100/50 to-purple-100/50 shadow-xl shadow-rose-200/40 scale-[1.01]'
                            : 'border-slate-200/30 bg-white/25 backdrop-blur-md hover:border-rose-200 hover:shadow-lg hover:scale-[1.01]'
                        }`}
                      >
                        {isLastUsed && (
                          <motion.div 
