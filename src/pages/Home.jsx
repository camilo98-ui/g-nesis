      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="lg:hidden min-h-screen flex flex-col justify-center relative z-10">
          <div className="flex-1 flex flex-col justify-center px-4 py-8 max-h-screen overflow-y-auto">
            <div className="max-w-md mx-auto w-full bg-white/0 backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-purple-200/40 p-6" style={{ boxShadow: '0 0 12px rgba(167, 139, 250, 0.25), 0 0 20px rgba(167, 139, 250, 0.15)' }}>
          ...
          <div className="w-[60%] flex items-center justify-center p-8 xl:p-10">
            <div className="w-full max-w-lg">
              <motion.div 
                ...
                className="bg-white/0 backdrop-blur-md rounded-3xl shadow-2xl border-2 border-purple-200/40 p-7 xl:p-8 space-y-5"
                style={{ boxShadow: '0 0 12px rgba(167, 139, 250, 0.25), 0 0 20px rgba(167, 139, 250, 0.15), 0 25px 80px -15px rgba(217, 70, 239, 0.3)' }}>
