...
// Cono con bolita estilo sketch y texto Popsy
const IceCreamCone = ({ opacity = 0.55 }) => (
  <svg viewBox="0 0 40 65" className="w-full h-full">
    ...
    <text x="20" y="46" textAnchor="middle" fontSize="5" fill="#ec4899" fontWeight="bold" opacity={opacity * 0.9}>Popsy</text>
  </svg>
);

// Malteada estilo sketch con texto
const Milkshake = ({ opacity = 0.5 }) => (
  <svg viewBox="0 0 35 60" className="w-full h-full">
    ...
    <text x="17.5" y="54" textAnchor="middle" fontSize="4.5" fill="#3b82f6" fontWeight="bold" opacity={opacity * 0.9}>Popsy</text>
  </svg>
);
...
// Litro de helado estilo sketch con texto
const IceCreamTub = ({ opacity = 0.55 }) => (
  <svg viewBox="0 0 40 50" className="w-full h-full">
    ...
    <text x="20" y="26" textAnchor="middle" fontSize="5" fill="white" fontWeight="bold" opacity={opacity}>Popsy</text>
    <text x="20" y="46" textAnchor="middle" fontSize="4" fill="#ec4899" fontWeight="bold" opacity={opacity * 0.8}>®</text>
  </svg>
);

// Copa de helado estilo sketch con texto
const IceCreamCup = ({ opacity = 0.55 }) => (
  <svg viewBox="0 0 35 55" className="w-full h-full">
    ...
    <text x="17.5" y="52" textAnchor="middle" fontSize="4" fill="#a855f7" fontWeight="bold" opacity={opacity * 0.9}>Popsy</text>
  </svg>
);
