...
const BASE_STORES = [
  ...
  { code: "BTA 27", name: "CC GRAN AHORRAR",        displayName: "BOGOTA 27 (CC GRAN AHORRAR - AV. CHILE)" },
  { code: "BTA 52", name: "CC CENTRO SUBA",       displayName: "BOGOTA 52 (CC CENTRO SUBA)" },
  { code: "BTA 56", name: "CC ECO PLAZA",          displayName: "BOGOTA 56 (CC ECO PLAZA)" },
  { code: "BTA 62", name: "CC FONTANAR",           displayName: "BOGOTA 62 (CC FONTANAR)" },
  { code: "BTA 66", name: "CC COLINA",             displayName: "BOGOTA 66 (CC PARQUE LA COLINA)" },
