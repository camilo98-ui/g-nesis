...
export default function RetailWeekBudgetCard({ dailySales, activeBudget, storeId, formatCurrency, onConfigureBudget, currentDateRange }) {
  ...
  const dailyBudget = activeBudget?.sales_budget ? activeBudget.sales_budget / daysInRetailMonth : 0;
  ...
  const remainingBudget = (activeBudget?.sales_budget || 0) - retailTotals.sales;
