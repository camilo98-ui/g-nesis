                          ...
                          <defs>
                            ...
                            <linearGradient id="lineGradientFirst" x1="0%" y1="0%" x2="100%" y2="0%">
                              <stop offset="-20%" stopColor="#fff" stopOpacity="0">
                                <animate attributeName="offset" values="-0.2;1.2;-0.2;-0.2" keyTimes="0;0.45;0.5;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="-10%" stopColor="#fff" stopOpacity="0.5">
                                <animate attributeName="offset" values="-0.1;1.3;-0.1;-0.1" keyTimes="0;0.45;0.5;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="0%" stopColor="#fff" stopOpacity="1">
                                <animate attributeName="offset" values="0;1.4;0;0" keyTimes="0;0.45;0.5;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="10%" stopColor="#fff" stopOpacity="0.5">
                                <animate attributeName="offset" values="0.1;1.5;0.1;0.1" keyTimes="0;0.45;0.5;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="20%" stopColor="#fff" stopOpacity="0">
                                <animate attributeName="offset" values="0.2;1.6;0.2;0.2" keyTimes="0;0.45;0.5;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                            </linearGradient>
                          </defs>
                          <Line 
                        ...
                        <LineChart data={budgetData.last7DaysSales} className="animated-line">
                          <defs>
                            ...
                            <linearGradient id="lineGradientSecond" x1="0%" y1="0%" x2="100%" y2="0%">
                              <stop offset="-20%" stopColor="#fff" stopOpacity="0">
                                <animate attributeName="offset" values="-0.2;-0.2;-0.2;1.2" keyTimes="0;0.5;0.55;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="-10%" stopColor="#fff" stopOpacity="0.5">
                                <animate attributeName="offset" values="-0.1;-0.1;-0.1;1.3" keyTimes="0;0.5;0.55;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="0%" stopColor="#fff" stopOpacity="1">
                                <animate attributeName="offset" values="0;0;0;1.4" keyTimes="0;0.5;0.55;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="10%" stopColor="#fff" stopOpacity="0.5">
                                <animate attributeName="offset" values="0.1;0.1;0.1;1.5" keyTimes="0;0.5;0.55;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                              <stop offset="20%" stopColor="#fff" stopOpacity="0">
                                <animate attributeName="offset" values="0.2;0.2;0.2;1.6" keyTimes="0;0.5;0.55;1" dur="6s" repeatCount="indefinite"/>
                              </stop>
                            </linearGradient>
                          </defs>
                          <Line 
