...
import NPSSummaryCard from './NPSSummaryCard';
      ...
      <main className="flex-1 min-w-0 flex overflow-hidden" style={{ height: '100vh' }}>
        ...
        <div className="flex-1 min-w-0 overflow-y-auto p-3 sm:p-5 lg:p-8">
          ...
          {!isGerente && <motion.div
            ...
            {/* Card 1 — Clima día por día de la semana actual */}
            <WeatherWeekCard weatherLast7={weatherLast7} />

            {/* Card 2 — NPS: tienda + distrito + tendencia mensual */}
            <NPSSummaryCard storeCode={selectedStore} district={selectedDistrict} />

            {/* Card 3 — Comportamiento de agregadores */}
            <AggregatorsWidget storeId={selectedStore} />
